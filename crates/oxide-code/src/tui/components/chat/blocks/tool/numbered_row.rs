...
mod tests {
    ...
    fn with_style_patches_row_bg_onto_content_spans() {
        ...
        assert_eq!(row.spans[1].style.bg, theme.diff_add_bg.bg);
        assert_eq!(row.spans[2].style.bg, theme.diff_add_bg.bg);
        assert_eq!(row.spans[3].style.bg, theme.diff_add_bg.bg);
    }
    ...
    fn with_style_pads_to_full_width_with_row_bg() {
        ...
        assert_eq!(last.style.bg, theme.diff_del_bg.bg);
    }
