...
/// Drives busy-gating: only `ReadOnly` may dispatch mid-turn; the App refuses `Mutating` and
...
pub(crate) enum SlashKind {
    ...
    /// Refused until the agent is idle.
    Mutating,
