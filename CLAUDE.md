...
│   ├── init.rs                             # /init — synthesizes an AGENTS.md / CLAUDE.md author-or-update prompt; SlashOutcome::PromptSubmit
...
│   ├── registry.rs                         # SlashCommand trait + SlashOutcome { Local, PromptSubmit } + BUILT_INS slice + alias-aware lookup_in
